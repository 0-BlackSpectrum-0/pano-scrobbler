...
data class MainPrefs(
    ...
    val temporaryScrobblePackages: Set<String> = emptySet(),
    ...
    val bypassProLock: Boolean = false,
    ...
    val themeCustom: Boolean = false,
    val themeCustomHex: String = "",
    ...
    val themeHueLight: Float = ThemeUtils.DEFAULT_HUE,
    val themeStyleLight: String = ThemeUtils.defaultThemeStyle.name,
    val themeContrastLight: ContrastMode = ContrastMode.LOW,
    val themeDynamicLight: Boolean = false,
    val themeRandomLight: Boolean = false,
    val themeCustomLight: Boolean = false,
    val themeCustomHexLight: String = "",
    ...
    data class Public(
        ...
        val themeDynamic: Boolean = defaultMainPrefs.themeDynamic,
        val themeRandom: Boolean = defaultMainPrefs.themeRandom,
        val themeCustom: Boolean = defaultMainPrefs.themeCustom,
        val themeCustomHex: String = defaultMainPrefs.themeCustomHex,
        ...
        val themeHueLight: Float = defaultMainPrefs.themeHueLight,
        val themeStyleLight: String = defaultMainPrefs.themeStyleLight,
        val themeContrastLight: ContrastMode = defaultMainPrefs.themeContrastLight,
        val themeDynamicLight: Boolean = defaultMainPrefs.themeDynamicLight,
        val themeRandomLight: Boolean = defaultMainPrefs.themeRandomLight,
        val themeCustomLight: Boolean = defaultMainPrefs.themeCustomLight,
        val themeCustomHexLight: String = defaultMainPrefs.themeCustomHexLight,
    ...
    fun updateFromPublicPrefs(prefs: Public) = copy(
        ...
        themeDynamic = prefs.themeDynamic,
        themeRandom = prefs.themeRandom,
        themeCustom = prefs.themeCustom,
        themeCustomHex = prefs.themeCustomHex,
        ...
        themeHueLight = prefs.themeHueLight,
        themeStyleLight = prefs.themeStyleLight,
        themeContrastLight = prefs.themeContrastLight,
        themeDynamicLight = prefs.themeDynamicLight,
        themeRandomLight = prefs.themeRandomLight,
        themeCustomLight = prefs.themeCustomLight,
        themeCustomHexLight = prefs.themeCustomHexLight,
    ...
    fun toPublicPrefs() = Public(
        ...
        themeHueLight = themeHueLight,
        themeStyleLight = themeStyleLight,
        themeContrastLight = themeContrastLight,
        themeDynamicLight = themeDynamicLight,
        themeRandomLight = themeRandomLight,
        themeCustomLight = themeCustomLight,
        themeCustomHexLight = themeCustomHexLight,
